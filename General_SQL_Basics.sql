-- Q1: Create table employees with constraints
...
-- Q2: Explain purpose of constraints and examples
/* 
...
/* 
Applying NOT NULL ensures a column always has a value (no missing data). 
...
-- Q4: Add or remove constraints on existing table
/*
...
The second insert fails with error: 
